...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-serial-sequence.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-serial-sequence)
...
```bash
php artisan vendor:publish --tag="laravel-serial-sequence-views"
```

## Usage

```php
$laravelSerialSequence = new Mawuva\LaravelSerialSequence();
echo $laravelSerialSequence->echoPhrase('Hello, Mawuva!');
```
